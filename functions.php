...
function cms_webdesign_child_theme_css_scripts() {
        ...
        wp_enqueue_style( 'cms_webdesign_child_theme_css', get_stylesheet_directory_uri() . '/style.css', array( 'cmswebdesign-font-awesome','cmswebdesign-main-style','cmswebdesign-woocommerce-style','cmswebdesign-tablet-style','cmswebdesign-spinner-style' ), '2.6', 'all' );

        wp_enqueue_script( 'cms_webdesign_child_theme_script', get_stylesheet_directory_uri() . '/js/child-scripts.js', array ( 'cmswebdesign-main-script', 'jquery', 'jquery-effects-slide' ), '2.4', true);
    }
